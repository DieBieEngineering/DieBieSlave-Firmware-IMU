#ifndef __DRIVERSWMPU9250_H
#define __DRIVERSWMPU9250_H

#include <string.h>
#include "driverHWSPI3.h"
#include "modDelay.h"
...
typedef enum{
	IMU0 = 0,
	IMU1
} driverSWMPU9250IMUDeviceNumer;

typedef struct {
	float x;
	float y;
	float z;
} driverSWMPU9250IMUAxis;

typedef struct {
	driverSWMPU9250IMUAxis acceleroMeter;
	driverSWMPU9250IMUAxis gyroscope;
	driverSWMPU9250IMUAxis compass;	
	float temperature;
	bool sensorPresent;
} driverSWMPU9250IMUDataStructTypedef;
...
void driverSWMPU9250SelectChipOnCS0(bool PinState);
void driverSWMPU9250SelectChipOnCS1(bool PinState);
